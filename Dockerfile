...
# Build
WORKDIR /root/SchoolAPIInputAgent
...
ENV School_AGENTPROPERTIES="/root/agent.properties"
# Copy in the properties file
COPY ./config/api.properties /root/api.properties
# Set the required environment variable
ENV School_APIPROPERTIES="/root/api.properties"
# Copy in the properties file
COPY ./config/client.properties /root/client.properties
# Set the required environment variable
ENV School_CLIENTPROPERTIES="/root/client.properties"
# Copy in the mapping folder
COPY ./config/mappings /root/mappings

# Set the required environment variable
ENV School_AGENT_MAPPINGS="/root/mappings"

COPY --from=builder /root/SchoolAPIInputAgent/output/school-agent##1.0.0.war $CATALINA_HOME/webapps/
